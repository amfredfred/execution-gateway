export default () => ({
  ...
  licensing: {
    ...
    variantStarterMonthly: process.env.LS_VARIANT_STARTER_MONTHLY
      ? Number(process.env.LS_VARIANT_STARTER_MONTHLY)
      : undefined,
    variantStarterYearly: process.env.LS_VARIANT_STARTER_YEARLY
      ? Number(process.env.LS_VARIANT_STARTER_YEARLY)
      : undefined,
    variantProMonthly: process.env.LS_VARIANT_PRO_MONTHLY
      ? Number(process.env.LS_VARIANT_PRO_MONTHLY)
      : undefined,
    variantProYearly: process.env.LS_VARIANT_PRO_YEARLY
      ? Number(process.env.LS_VARIANT_PRO_YEARLY)
      : undefined,
    variantInfrastructure: process.env.LS_VARIANT_INFRASTRUCTURE
      ? Number(process.env.LS_VARIANT_INFRASTRUCTURE)
      : undefined,
  },
  webhooks: {
